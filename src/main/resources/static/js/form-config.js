(function(global){
    ...
    const entityMessages = {
        Account: 'You are creating an account.',
        Address: 'You are creating an address.',
        AudioDevice: 'You are creating an audio device.',
        City: 'You are creating a city.',
        Country: 'You are creating a country.',
        DeploymentVariant: 'You are creating a deployment variant.',
        InstalledSoftware: 'You are creating an installed software record.',
        PhoneIntegration: 'You are creating a phone integration.',
        Project: 'You are creating a project.',
        Radio: 'You are creating a radio.',
        Server: 'You are creating a server.',
        ServiceContract: 'You are creating a service contract.',
        Site: 'You are creating a site.',
        Software: 'You are creating a software record.',
        UpgradePlan: 'You are creating a software upgrade plan.',
        WorkingPosition: 'You are creating a workstation (client).' 
    };
    ...
    const entityFields = {
        ...
        AudioDevice: [
            ...
            { id: 'serial', label: 'Serial no.', component: 'input', name: 'DeviceSerialNr', required: false },
            { id: 'fw', label: 'Firmware', component: 'input', name: 'AudioDeviceFirmware', required: false },
            { id: 'dtype', label: 'Device type', component: 'select', options: ['HEADSET','SPEAKER','MIC'], name: 'DeviceType' }
        ],
        City: [
        ...
        DeploymentVariant: [
            { id: 'variantCode', label: 'Variant code', component: 'input', name: 'VariantCode' },
            { id: 'variantName', label: 'Variant name', component: 'input', name: 'VariantName' },
            { id: 'description', label: 'Description', component: 'input', name: 'Description', required: false },
            { id: 'active', label: 'Is active', component: 'select', options: ['true','false'], name: 'IsActive', valueType: 'boolean' }
        ],
        InstalledSoftware: [
        ...
        PhoneIntegration: [
            { id: 'client', label: 'Select client', component: 'asyncSelect', source: 'clients', placeholder: 'Select client', name: 'ClientID' },
            { id: 'type', label: 'Phone type', component: 'select', options: ['Emergency','NonEmergency','Both'], name: 'PhoneType' },
            { id: 'brand', label: 'Brand', component: 'input', name: 'PhoneBrand', required: false },
            { id: 'serial', label: 'Serial no.', component: 'input', name: 'PhoneSerialNr', required: false },
        ...
        Radio: [
            ...
            { id: 'serial', label: 'Serial no.', component: 'input', name: 'RadioSerialNr', required: false },
            ...
            { id: 'client', label: 'Assigned client ID (UUID)', component: 'asyncSelect', source: 'clients', name: 'AssignedClientID', required: false, placeholder: 'Select client (optional)', dependsOn: 'siteId' }
        ],
        Server: [
            { id: 'siteId', label: 'Select site', component: 'asyncSelect', source: 'sites', name: 'SiteID' },
            ...
            { id: 'serial', label: 'Serial no.', component: 'input', name: 'ServerSerialNr', required: false },
            ...
            { id: 'ha', label: 'High availability', component: 'select', options: ['true','false'], name: 'HighAvailability', valueType: 'boolean' }
        ],
        ServiceContract: [
            ...
            { id: 'siteID', label: 'Select site', component: 'asyncSelect', source: 'sites', placeholder: 'Select site', allowManual: false, dependsOn: 'projectID', emptyText: 'No sites available for the selection', name: 'SiteID' },
        ...
        Site: [
            ...
            { id: 'addrId', label: 'Select address', component: 'asyncSelect', source: 'addresses', allowManual: false, placeholder: 'Select address', name: 'AddressID' },
            { id: 'zone', label: 'Fire zone', component: 'input', name: 'FireZone', required: false },
            { id: 'tenant', label: 'Tenant count', component: 'input', inputType: 'number', min: '0', step: '1', required: false, name: 'TenantCount' }
        ],
        Software: [
            ...
            { id: 'swPhase', label: 'Support phase', component: 'select', options: ['Preview','Production','EoL'], name: 'SupportPhase' },
        ...
        WorkingPosition: [
            ...
            { id: 'serial', label: 'Serial no.', component: 'input', name: 'ClientSerialNr', required: false },
            { id: 'os', label: 'Operating system', component: 'input', name: 'ClientOS', required: false },
            { id: 'patch', label: 'Patch level', component: 'input', name: 'PatchLevel', required: false },
            { id: 'install', label: 'Install type', component: 'select', options: ['LOCAL','BROWSER'], name: 'InstallType' }
        ]
    };
